...
#
# REVIEWER RESPONSE (Reviewer 1, Issue 3; Reviewer 2):
...
# =============================================================================
# SUPPLEMENTARY: H_B(G) entropy component — independent predictive content (R5)
#
# Reviewer C asked whether the boundary entropy term H_B(G) in CLS(G) carries
...
# =============================================================================
# v14: STANDARDISED RATIO COMPUTATION (corrected from v13)
...
# (Previously erroneously stated as 7.8-fold)
# =============================================================================
