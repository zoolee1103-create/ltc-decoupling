...
#
# REVISION v4 (addresses Reviewer A Issues 1 & 2):
#
# FIX A — ACME scale and proportion-mediated calculation (P1 pathway):
...
#
# FIX B — mediation::mediate() cluster= argument removed:
...
#
# FIX C — p1_data filter: adl_baseline == 0 only (no outcome pre-filtering).
# FIX D — P3 logistic regression (binary outcome; OR not IRR).
# FIX E — Days → months unit conversion (÷ 30.44).
# =============================================================================
...
#     FIX: cluster= is NOT a valid arg in mediation::mediate(); removed.
